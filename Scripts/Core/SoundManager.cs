...
public class SoundManager : MonoBehaviour
{
   ...
   /*  float baseVolume = 1;
        ...
        float currentVolume = PlayerPrefs.GetFloat("soundVolume", 1);  //Load last saved sound volume from player prefs
    ...
    public void ChangeMusicVolume(float _change)
    {
        ...
        /*   float baseVolume = 0.3f;
             ...
             //Get initial value of volume and change it
             float currentVolume = PlayerPrefs.GetFloat("musicVolume", 1);  //Load last saved sound volume from player prefs
             currentVolume += _change;
